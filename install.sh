...
maybe_link "$SCRIPT_DIR/voxtype/config.toml" "$HOME/.config/voxtype/config.toml"
...
maybe_link "$SCRIPT_DIR/bash/git-pager" "$HOME/.local/bin/git-pager"
maybe_link "$SCRIPT_DIR/bash/git-diff-filter" "$HOME/.local/bin/git-diff-filter"
...
git config --global color.diff-highlight.oldHighlight "black red"
git config --global color.diff-highlight.newNormal "green"
git config --global color.diff-highlight.newHighlight "black green"
